...
// import { fetchContractTx } from "@/app/actions/front-end/contract";
...
//     // console.log("EXEC", deploymentAddress);
//     // const { dx2, data } = await fetchContractTx(deploymentAddress, alchemy);
